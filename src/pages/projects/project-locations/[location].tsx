...
const index = ({ projects }: { projects: Project[] }) => {
  ...
  return (
    <>
      <Head>
        <title>Prime Plots in {location} - Optiven</title>
        <meta
          name="description"
          content={`Explore our prime plots in ${location}. Discover versatile investment solutions with Optiven.`}
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content={`plots in ${location}, real estate ${location}, investment opportunities ${location}, Optiven properties`}
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content={`Prime Plots in ${location} - Optiven`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://www.optiven.co.ke/project-locations/${location}`}
        />
        ...
        <link
          rel="canonical"
          href={`https://www.optiven.co.ke/project-locations/${location}`}
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Optiven",
            url: `https://www.optiven.co.ke/project-locations/${location}`,
            logo: "https://www.optiven.co.ke/images/logo.png",
            description: `Explore our prime plots in ${location}. Discover versatile investment solutions with Optiven.`,
            areaServed: {
              "@type": "Place",
              name: location,
            },
        ...
        <section className="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
          <div className="pt-8 px-4 mx-auto max-w-screen-xl text-center lg:pt-16 z-10 relative">
            ...
            <p className="text-start mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
              ...
              promising locations ensure optimal returns. Our properties are
              both accessible and affordable, designed to deliver quality
              without compromise. With flexible installment plans starting at
              accessible rates, securing your future has never been easier with
              us.
            </p>
          </div>
