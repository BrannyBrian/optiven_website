    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          ...
          budget. Each level has its value additions. The levels are also based
          on location and proximity to infrastructure. Market prices are thus
          ...
          <div className="flex">
            ...
            <div className="pt-1 pb-8">
              ...
              <p className="text-gray-700">
                This level of a project comes with sophisticated value additions
                such as paved cabro roads, CCTV, stone perimeter fencing, and a
                spectacular entry gate, to mention a few.
              </p>
